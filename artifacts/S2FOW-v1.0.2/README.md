...
Default smoke timing counts CS2 smokes as 19 seconds for S2FOW visibility (`SmokeLifetimeTicks = 1216` at 64 tick) and uses a 4 second bloom (`SmokeBloomDurationTicks = 256`) to avoid excessive hiding.
